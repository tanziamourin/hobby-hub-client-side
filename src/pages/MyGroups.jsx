...
const MyGroups = () => {
  ...
  const fetchGroups = () => {
    ...
    fetch(`https://hobby-hub-server-gamma.vercel.app/myGroups?email=${user.email}`)
      .then((res) => res.json())
      .then((data) => {
        setGroups(data);
      })
  ...
  const handleDelete = async (id) => {
    if (confirm("Are you sure you want to delete this group?")) {
      const res = await fetch(`https://hobby-hub-server-gamma.vercel.app/groups/${id}`, {
        method: "DELETE",
      });
      if (res.ok) {
  ...
  const handleUpdateSubmit = async (e) => {
    ...
    const res = await fetch(
      `https://hobby-hub-server-gamma.vercel.app/groups/${selectedGroup._id}`,
      {
        method: "PUT",
